...
window.MMCDShell=async function(active){
  ...
  <aside class="sidebar sidebar-v23">
   ...
   <nav class="sidebar-nav" aria-label="Navegação principal">
    ...
    <div class="sidebar-settings ${settingsOpen?'open':''}">
     <button
      type="button"
      class="sidebar-link sidebar-settings__toggle ${settingsActive?'active':''}"
      id="sidebar-settings-toggle"
      aria-expanded="${settingsOpen?'true':'false'}"
      aria-controls="sidebar-settings-menu"
     >
      <span class="sidebar-link__icon">08</span>
     ...
     <div
      class="sidebar-subnav ${settingsOpen?'open':''}"
      id="sidebar-settings-menu"
      ${settingsOpen?'':'hidden'}
     >
      <a class="sidebar-subnav__link ${active==='metas'?'active':''}" href="metas.html">
       <span class="sidebar-subnav__dot"></span>
       <span><strong>Metas</strong><small>Rotina e objetivos</small></span>
      </a>
      <a class="sidebar-subnav__link ${active==='series'?'active':''}" href="series.html">
       <span class="sidebar-subnav__dot"></span>
       <span><strong>Séries & filmes</strong><small>Biblioteca de exposição</small></span>
      </a>
     </div>
    </div>
   </nav>
 ...
 if(settings&&settingsButton&&settingsMenu){
  ...
  if(settingsActive)setSettingsOpen(true,false);
 }
