...
(async()=>{
  ...
  if(overdue.length){const p=overdue[0];attention.push({icon:"❤️",title:`${p.nome} pode estar pedindo presença`,text:p.since>1000?"Você ainda não registrou um cuidado com essa pessoa.":`Último cuidado registrado há ${p.since} dias.`,href:"circulo-cuidado.html?v=20260815-v76",action:"Ver Círculo"})}
