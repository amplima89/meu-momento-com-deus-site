...
(async()=>{
  ...
  if(attention.length<3)attention.push({icon:"🌳",title:"Olhe o todo, não só a tarefa",text:"A Árvore da Vida reúne Espiritual, Corpo, Mente, Relacionamentos, Desenvolvimento e Memórias.",href:"arvore-da-vida.html"});
