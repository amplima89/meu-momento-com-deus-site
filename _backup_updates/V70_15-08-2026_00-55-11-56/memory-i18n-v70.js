...
(()=>{
 ...
 const titleMap=new Map(Object.entries({
  "Missões — Memory":"Memory - Missions","Atividades Diárias — Memory":"Memory - Activities","Metas — Memory":"Memory - Goals","Memory - Metas":"Memory - Goals","Memory - Configurações":"Memory - Settings","Aparência — Configurações — Memory":"Memory - Settings - Appearance","Medições corporais — Configurações — Memory":"Memory - Settings - Body measurements","Meu perfil — Memory":"Memory - Profile","Plano de treino — Configurações — Memory":"Memory - Settings - Workout plan","Séries & filmes — Memory":"Memory - Series & movies","Memory - Aniversários":"Memory - Birthdays","Memory - Links da meditação":"Memory - Meditation links","Inglês diário — Memory":"Memory - Daily English","Evolução do inglês — Memory":"Memory - English progress","Treinos — Memory":"Memory - Workouts","Memory — Treinos":"Memory - Workouts","Livros — Memory":"Memory - Books","Bíblia online — Memory":"Memory - Bible","Mapa da Bíblia — Memory":"Memory - Bible map","Meditação — Memory":"Memory - Meditation","Análise de atividades — Memory":"Memory - Activity analysis","Memory — Propósito e essência":"Memory - Purpose & essence"
 }));
