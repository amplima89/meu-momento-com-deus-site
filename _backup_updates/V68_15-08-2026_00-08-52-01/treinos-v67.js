...
(() => {
  ...
  function activeActivityMetas(date=todayIso()){
    ...
    // metasNaData já respeita vigência, status e os dias programados da meta.
  ...
  function linkedActivityMetasForWorkout(session){
    ...
    return activeActivityMetas(session.data).filter(meta=>meta?.associadaTreinoFisico===true);
  }
