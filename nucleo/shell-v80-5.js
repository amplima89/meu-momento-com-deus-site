  ...
  <aside class="sidebar sidebar-v24">
   ...
   <nav class="sidebar-nav" aria-label="Navegação principal">
    ...
    <div class="sidebar-settings sidebar-care-group ${careActive?'open':''}">
     <a href="mapa-cuidado.html?v=20260816-v80-5" class="sidebar-link sidebar-settings__toggle ${careActive?'active':''}" aria-expanded="${careActive?'true':'false'}" aria-controls="sidebar-care-menu" title="Abrir Mapa de Cuidado">
     ...
     <div class="sidebar-subnav ${careActive?'open':''}" id="sidebar-care-menu" ${careActive?'':'hidden'}>
      <a class="sidebar-subnav__link ${active==='mapa-cuidado'||active==='arvore-da-vida'?'active':''}" href="mapa-cuidado.html?v=20260816-v80-5"><span class="sidebar-subnav__dot"></span><span><strong>Mapa de Cuidado</strong><small>Visão integral</small></span></a>
      <a class="sidebar-subnav__link ${active==='aniversarios'?'active':''}" href="aniversarios.html?v=20260816-v80-5"><span class="sidebar-subnav__dot"></span><span><strong>Aniversariantes</strong><small>Datas e gestos de cuidado</small></span></a>
      <a class="sidebar-subnav__link ${active==='boas-acoes'?'active':''}" href="boas-acoes.html?v=20260816-v80-5"><span class="sidebar-subnav__dot"></span><span><strong>Boas Ações</strong><small>Cuidado colocado em prática</small></span></a>
      <a class="sidebar-subnav__link ${active==='oracoes'?'active':''}" href="oracoes.html?v=20260816-v80-5"><span class="sidebar-subnav__dot"></span><span><strong>Minhas Orações</strong><small>Pedidos e Memórias de Deus</small></span></a>
      <a class="sidebar-subnav__link ${active==='registro-rapido'?'active':''}" href="registro-rapido.html?v=20260816-v80-5"><span class="sidebar-subnav__dot"></span><span><strong>Registro rápido</strong><small>Memória de curto prazo</small></span></a>
      <a class="sidebar-subnav__link ${active==='circulo-cuidado'?'active':''}" href="circulo-cuidado.html?v=20260816-v80-5"><span class="sidebar-subnav__dot"></span><span><strong>Relacionamentos</strong><small>Presença com quem importa</small></span></a>
      <a class="sidebar-subnav__link ${active==='testemunhos'?'active':''}" href="testemunhos.html?v=20260816-v80-5"><span class="sidebar-subnav__dot"></span><span><strong>Testemunhos</strong><small>Memórias do que Deus fez</small></span></a>
     </div>
    </div>
    ${navAfterCareHtml}
