...
window.MMCDShell=async function(active){
 ...
 const mobileMemoryHtml=`
  <a class="sidebar-link sidebar-memory-mobile ${active==='memory'?'active':''}" href="memory.html?v=20260815-v76" aria-label="Abrir Memory">
   <span class="sidebar-link__icon sidebar-memory-mobile__icon"><img src="assets/imagens/memory-mark-official-v80-1.png?v=20260817-v81-2-3" alt=""></span>
  ...
  <aside class="sidebar sidebar-v24">
   <a class="sidebar-brand" href="memory.html?v=20260815-v76" aria-label="Abrir propósito e essência do Memory" title="Abrir Memory">
    <span class="sidebar-brand__mark">
     <img src="assets/imagens/memory-mark-official-v80-1.png?v=20260817-v81-2-3" alt="Memory">
 ...
 document.querySelectorAll('.app-topbar__title').forEach(el=>{el.innerHTML='<a class="memory-topbar-brand" href="memory.html?v=20260815-v76" aria-label="Abrir Memory"><img src="assets/imagens/memory-mark-official-v80-1.png?v=20260817-v81-2-3" alt=""><span>Memory</span></a>'});
 const memoryTitles={
  memory:'Memory',
 ...
 if(logo){
  ...
  const fallback=()=>{
   if(logo.dataset.memoryFallbackTried!=='1'){
    ...
    logo.src='assets/imagens/memory-mark-v62.png?v=20260817-v81-2-3';
    return;
   }
