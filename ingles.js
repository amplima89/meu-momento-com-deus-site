...
(async()=>{
 ...
 box.addEventListener('click',async e=>{const m=e.target.closest?.('mark.english-highlight');if(!m)return;m.replaceWith(...m.childNodes);box.normalize();await salvar();MMCDUI.toast('Marcação removida.')});
