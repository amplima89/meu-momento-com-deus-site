  ...
  root.innerHTML=`
   ...
   <section class="journey-v783__focus">
    <aside class="journey-v783__focus-card">
     ...
     <div class="journey-v783__focus-meta"><span><b>${latest?fmt(latest.data):'—'}</b><small>última meditação</small></span><span><b>${list.length}</b><small>dias para revisitar</small></span></div>
    </aside>
