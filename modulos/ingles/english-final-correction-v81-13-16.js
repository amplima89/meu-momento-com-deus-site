...
window.MMCDEnglishFinalCorrectionV811316 = (() => {
  const FINAL_KEY="ingles_correcao_final_v81_13_16";
    ...
    host.innerHTML=`
      <section class="english-final-clean">
        ...
        <p class="english-final-clean__helper">
          A IA lê o texto completo, analisa a Leitura e corrige suas respostas da Conversa e da Prática em contexto.
        </p>
      </section>
    `;
