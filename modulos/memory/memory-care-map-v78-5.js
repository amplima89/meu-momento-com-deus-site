...
(async()=>{
 ...
 const dimensions=[
  {key:'spiritual',icon:'🙏',name:'Espiritual',question:'Tenho separado espaço para Deus e para aquilo que sustenta minha fé?',score:null,observes:'Devocional, Bíblia, oração e outras práticas espirituais que você cadastrou.',evidence:'Carregando seus registros recentes…',actions:[{label:'Fazer a devocional de hoje',href:'meditacao.html',primary:true},{label:'Abrir Minhas Orações',href:'oracoes.html'}]},
