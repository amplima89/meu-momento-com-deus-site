...
(() => {
          ...
          <div class="exercise-card__head">
            ...
            <div class="exercise-head-actions">
              ...
              ${!locked?`<button type="button"
                ...
                aria-label="${done?"Exercício concluído":"Concluir exercício"}"
                title="${done?"Exercício concluído":"Concluir exercício com as cargas preenchidas"}">
                ${done?"✓":"○"}
              </button>`:""}
  ...
  function quickCompleteExercise(exerciseId) {
    ...
    if(ex.registro==="peso_reps") {
      // Se pelo menos uma série tem carga, ela pode servir de referência para
      // séries ainda vazias do mesmo exercício.
